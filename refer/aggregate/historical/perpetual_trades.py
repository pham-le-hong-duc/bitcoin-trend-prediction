"""
Perpetual Trades Historical Aggregation using HistoricalAggregator
"""
import sys
...
def process_perpetual_trades():
    """Process perpetual trades historical data - detect and fill gaps"""
