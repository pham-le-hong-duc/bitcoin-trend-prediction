"""
Index Price Klines Historical Aggregation using HistoricalAggregator
"""
import sys
...
def process_index_klines():
    """Process index price klines historical data - detect and fill gaps"""
